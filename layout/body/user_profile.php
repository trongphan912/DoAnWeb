                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                                    <h5>
                                    	 <?php if(!empty($_SESSION['NguoiDung'])){ ?>
                                    	 	<?php echo $_SESSION['NguoiDung']["ten"]; ?>
                                        <?php }?>
                                    </h5>
                                    <h6>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Đơn hàng đã mua</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p>
                                                	<?php if(!empty($_SESSION['NguoiDung'])){ ?>
			                                    	 	<?php echo $_SESSION['NguoiDung']["id"]; ?>
			                                        <?php }?>
                                        	</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p>
                                                	<?php if(!empty($_SESSION['NguoiDung'])){ ?>
			                                    	 	<?php echo $_SESSION['NguoiDung']["email"]; ?>
			                                        <?php }?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p>
                                                	<?php if(!empty($_SESSION['NguoiDung'])){ ?>
			                                    	 	<?php echo $_SESSION['NguoiDung']["sdt"]; ?>
			                                        <?php }?>
                                        	</p>
                                            </div>
                                        </div>
